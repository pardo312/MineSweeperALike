...
namespace JiufenGames.MineSweeperAlike.Gameplay.Logic
{
    public class GameplayController : MonoBehaviour
    {
        ...
        #region Methods
        #region Init
        public void Init(BoardDifficulty difficulty, bool gameExist, BoardSaveData boardData)
        {
            LeanTween.init(2300);

            CreateBoardData payload = new CreateBoardData()
            {
        ...
        private void EndGame(bool won)
        {
            ...
            buttonDictionary.Add(ButtonType.RESET, () =>
            {
                ServiceLocator.m_Instance.GetService<IPopupManager>().HidePopup(ResetGame);
            });
        ...
        public void LoadBoard(BoardSaveData boardData)
        {
